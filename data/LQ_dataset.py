...
class LQDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        Initial_H, Initial_W ,_ = img_LR.shape
        img_LR = np.pad(img_LR, ((0, 4), (0, 4), (0, 0)), mode='constant', constant_values=0)
        ...
        print(img_LR.shape)
        return {"LQ": img_LR, "LQ_path": LR_path, "Initial_H": Initial_H, "Initial_W": Initial_W}
